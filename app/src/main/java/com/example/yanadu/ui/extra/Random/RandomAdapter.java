...
public class RandomAdapter extends RecyclerView.Adapter<RandomAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.random_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Random item = items.get(position);
        holder.setItem(item);
        holder.setLayout();
    }
...
//        CheckBox checkBox;
        ...
        public ViewHolder(View itemView){
            ...
            editText=itemView.findViewById(R.id.inputR);
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                private void deleteToDo(String TODO){
                    ...
                    String deleteSql = "delete from " + RandomDatabase.TABLE_NOTE + " where " + "  TODO = '" + TODO+"'";
        ...
        public void setItem(Random item){
            editText.setText(item.getTodo());
        }
    ...
    //배열에 있는 item들을 가리킴
    public void setItems(ArrayList<Random> items){
        this.items = items;
    }
