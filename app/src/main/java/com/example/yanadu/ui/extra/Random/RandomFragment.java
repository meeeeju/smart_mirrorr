...
public class RandomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_random, container, false);
        ...
        //당겨서 새로고침
        swipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.refresh_layoutRandom);
    ...
    private void initUI(ViewGroup rootView){
        ...
        //recyclerView연결
        recyclerView = rootView.findViewById(R.id.recyclerViewRandom);
